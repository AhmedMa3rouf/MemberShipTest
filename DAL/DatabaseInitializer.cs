    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                const string adminRoleName = RolesConstants.AdminRole; //"administrator";
                const string userRoleName = RolesConstants.UserRole; //"user";

                await EnsureRoleAsync(adminRoleName, "Default administrator", ApplicationPermissions.GetAllPermissionValues());
                await EnsureRoleAsync(userRoleName, "Default user", new string[] { });

                await CreateUserAsync("admin@pl.com", "123456", "admin@pl.com", "+1 (123) 000-0000", new string[] { adminRoleName }, 
                    new UserProfile { 
                        FullName="Admin User",
                        Gender = Gender.Male
                    });
                await CreateUserAsync("user@pl.com", "123456", "user@pl.com", "+1 (123) 000-0001", new string[] { userRoleName }, 
                    new UserProfile{
                        FullName="Test User",
                        Gender = Gender.Male
                    });
        ...
        private async Task<ApplicationUser> CreateUserAsync(string userName, string password, string email, string phoneNumber, string[] roles, UserProfile userProfile)
        {
